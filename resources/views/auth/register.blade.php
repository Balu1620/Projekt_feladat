                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="drivingLicenceNumber" maxlength="8" type="text" class="form-control @error('drivingLicenceNumber') is-invalid @enderror" name="drivingLicenceNumber" value="{{ old('drivingLicenceNumber') }}" required autocomplete="drivingLicenceNumber" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="drivingLicenceType" id="drivingLicenceType" class="form-control @error('drivingLicenceType') is-invalid @enderror" required autocomplete="drivingLicenceType" autofocus>
